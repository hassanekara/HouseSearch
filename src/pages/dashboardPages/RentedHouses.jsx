...
import { DELETE_MYHOUSE_DATA, GET_FILTERED_RENTED_HOUSES_DATA } from '../../database/queries/MyHouseQueries';

const HouseTable = () => {
  const { loading, error, data } = useQuery(GET_FILTERED_RENTED_HOUSES_DATA);
  ...
  return (
    ...
    <table>
      ...
      <tbody>
        {data.getFilteredRentedHouses.map((house) => (
          <tr key={house._id}>
            <td>{house._id}</td>
